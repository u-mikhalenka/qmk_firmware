...
const uint16_t  PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_SFT_BASE] = LAYOUT_wrapper(
    LAYER_SFT_BASE_L1, LAYER_SFT_BASE_R1,
    LAYER_SFT_BASE_L2, LAYER_SFT_BASE_R2,
    LAYER_SFT_BASE_L3, LAYER_SFT_BASE_R3,
    LAYER_SFT_BASE_L4, LAYER_SFT_BASE_R4,
    LAYER_SFT_BASE_LT, LAYER_SFT_BASE_RT
  ),

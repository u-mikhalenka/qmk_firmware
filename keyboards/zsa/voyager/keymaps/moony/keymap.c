...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_voyager(
    ...
    U_CAPS,         HOME_A,         HOME_S,         HOME_D,         HOME_F,         KC_G,                                           ALL_T(KC_H),    HOME_J,         HOME_K,         HOME_L,         HOME_SCLN,      KC_QUOTE,
    U_LANG,         KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       LT(LAYER_SYS,KC_ENTER),

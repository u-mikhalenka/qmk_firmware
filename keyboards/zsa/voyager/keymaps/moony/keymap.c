...
const uint16_t  PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_voyager(
    KC_EQUAL,       KC_EXLM,        KC_AT,          KC_LPRN,        KC_RPRN,             KC_LABK,                                   KC_RABK,        KC_LBRC,        KC_RBRC,        KC_EQUAL,       XXXXXXX,        KC_MINUS,
    ...
    U_LANG,         KC_Z,           KC_X,           KC_C,           LT(LAYER_FN, KC_V),  KC_B,                                      KC_N,           ALL_T(KC_M),    KC_COMMA,       KC_DOT,         KC_SLASH,       KC_BSPC,
                                                    U_SHIFT,        LT(LAYER_NUM,KC_TAB),                                           LT(LAYER_NUM_LEFT,KC_ENTER), LT(LAYER_NAV,KC_SPACE)
  ),
  ...
  [LAYER_NAV] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, LCTL(KC_Z),     LCTL(KC_X),     LCTL(KC_C),     LT(LAYER_FN, KC_V),     KC_TRANSPARENT,                                 KC_BSPC,        KC_DELETE,      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [LAYER_FN] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_PAUSE,       KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_F12,         KC_F7,          KC_F8,          KC_F9,          KC_APPLICATION, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_LEFT_GUI,    KC_LEFT_ALT,    KC_LEFT_CTRL,   KC_LEFT_SHIFT,  KC_TRANSPARENT,                                 KC_F11,         KC_F4,          KC_F5,          KC_F6,          KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [LAYER_SYS] = LAYOUT_voyager(
      RGB_VAI,        RGB_VAD,        RGB_SLD,                RGB_SPI,              RGB_SPD,               RGB_MODE_FORWARD,        QK_BOOT,        KC_TRANSPARENT, KC_TRANSPARENT, KC_PSCR,        KC_PAUSE,       PC_MODE,
      RGB_SAI,        RGB_SAD,        KC_AUDIO_MUTE,          KC_AUDIO_VOL_UP,      KC_AUDIO_VOL_DOWN,     KC_TRANSPARENT,          KC_MS_ACCEL2,   KC_MS_WH_DOWN,  KC_MS_UP,       KC_MS_WH_UP,    KC_APPLICATION, MAC_MODE,
      ...
      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,         LSFT(KC_PSCR),        KC_PSCR,               (0),                     KC_MS_ACCEL0,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_DELETE,
